...
namespace TimeLineTool
{
    ...
    public abstract class TimeLineControlBase : Canvas
    {
		...
		public static readonly DependencyProperty FocusOnItemProperty =
			DependencyProperty.Register("FocusOnItem", typeof(ITimeLineDataItem), typeof(TimeLineControlBase), new UIPropertyMetadata(null, new PropertyChangedCallback(FocusItemChanged)));
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty ReadOnlyProperty =
			DependencyProperty.Register("ReadOnly", typeof(Boolean), typeof(TimeLineControlBase), new UIPropertyMetadata(false));
		#endregion
		// Иванов - 04.02.2016 - конец добавлено
		...
		public static readonly DependencyProperty ManagerProperty =
			DependencyProperty.Register("Manager", typeof(ITimeLineManager), typeof(TimeLineControlBase), new UIPropertyMetadata(null));
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty MinWidthProperty =
			DependencyProperty.Register("MinWidth", typeof(Double), typeof(TimeLineControlBase), new UIPropertyMetadata(0.0));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		public static readonly DependencyProperty MinHeightProperty =
			DependencyProperty.Register("MinHeight", typeof(Double), typeof(TimeLineControlBase), new UIPropertyMetadata(0.0));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		public static readonly DependencyProperty MinimumUnitWidthProperty =
			DependencyProperty.Register("MinimumUnitWidth", typeof(Double), typeof(TimeLineControlBase), new UIPropertyMetadata(10.0, new PropertyChangedCallback(OnBackgroundValueChanged)));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		//		new UIPropertyMetadata(null));
		public static readonly DependencyProperty SnapToGridProperty =
			DependencyProperty.Register("SnapToGrid", typeof(Boolean), typeof(TimeLineControlBase), new UIPropertyMetadata(null));
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty DrawTimeGridProperty =
			DependencyProperty.Register("DrawTimeGrid", typeof(Boolean), typeof(TimeLineControlBase), new UIPropertyMetadata(false, new PropertyChangedCallback(OnDrawTimeGridChanged)));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		//					new PropertyChangedCallback(OnBackgroundValueChanged)));
		public static readonly DependencyProperty MinorUnitThicknessProperty =
			DependencyProperty.Register("MinorUnitThickness", typeof(int), typeof(TimeLineControlBase), new UIPropertyMetadata(1, new PropertyChangedCallback(OnBackgroundValueChanged)));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		public static readonly DependencyProperty MajorUnitThicknessProperty =
			DependencyProperty.Register("MajorUnitThickness", typeof(int), typeof(TimeLineControlBase), new UIPropertyMetadata(3, new PropertyChangedCallback(OnBackgroundValueChanged)));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		//			new PropertyChangedCallback(OnBackgroundValueChanged)));
		public static readonly DependencyProperty DayLineBrushProperty =
			DependencyProperty.Register("DayLineBrush", typeof(Brush), typeof(TimeLineControlBase), 
				new UIPropertyMetadata(new SolidColorBrush(new Color() { R = _defC, G = _defC, B = _defC, A = 255 }), 
				new PropertyChangedCallback(OnBackgroundValueChanged)));
		// Иванов - 05.02.2016 - конец изменено
		#endregion
		...
		//		new PropertyChangedCallback(OnBackgroundValueChanged)));
		public static readonly DependencyProperty HourLineBrushProperty =
			DependencyProperty.Register("HourLineBrush", typeof(Brush), typeof(TimeLineControlBase),
				new UIPropertyMetadata(new SolidColorBrush(new Color() { R = _defC, G = _defC, B = _defC, A = 255 / 2 }), new PropertyChangedCallback(OnBackgroundValueChanged)));
		// Иванов - 05.02.2016 - конец изменено
		...
		//		new PropertyChangedCallback(OnBackgroundValueChanged)));
		public static readonly DependencyProperty MinuteLineBrushProperty =
			DependencyProperty.Register("MinuteLineBrush", typeof(Brush), typeof(TimeLineControlBase),
				new UIPropertyMetadata(new SolidColorBrush(new Color() { R = _defC, G = _defC, B = _defC, A = 255 / 3 }), new PropertyChangedCallback(OnBackgroundValueChanged)));
		#endregion
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty ItemTemplateProperty =
			DependencyProperty.Register("ItemTemplate", typeof(DataTemplate), typeof(TimeLineControlBase),
		...
		public static readonly DependencyProperty ItemsProperty =
			DependencyProperty.Register("Items", typeof(ObservableCollection<ITimeLineDataItem>), typeof(TimeLineControlBase),
				new UIPropertyMetadata(null, new PropertyChangedCallback(OnItemsChanged)));
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty UnitSizeProperty =
			DependencyProperty.Register("UnitSize", typeof(Double), typeof(TimeLineControlBase), new UIPropertyMetadata(5.0, new PropertyChangedCallback(OnUnitSizeChanged)));
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty StartDateProperty =
			DependencyProperty.Register("StartDate", typeof(DateTime), typeof(TimeLineControlBase), new UIPropertyMetadata(DateTime.MinValue, new PropertyChangedCallback(OnStartDateChanged)));
		// Иванов - 05.02.2016 - конец изменено
		...
		public static readonly DependencyProperty EndDateProperty =
			DependencyProperty.Register("EndDate", typeof(DateTime), typeof(TimeLineControlBase),
				new UIPropertyMetadata(DateTime.MaxValue, new PropertyChangedCallback(OnEndDateChanged)));
		...
		public static readonly DependencyProperty ManipulationModeProperty =
			DependencyProperty.Register("ManipulationMode", typeof(TimeLineManipulationMode), typeof(TimeLineControlBase), new UIPropertyMetadata(TimeLineManipulationMode.Free));
		// Иванов - 05.02.2016 - конец изменено
		#endregion

        #endregion

		public TimeLineControlBase()
        {
			...
			// Иванов - 04.02.2016 - раскомментировано
			Items = new ObservableCollection<ITimeLineDataItem>();
            // Иванов - 04.02.2016 - конец раскомментировано
        ...
        private void InitializeItems(ObservableCollection<ITimeLineDataItem> observableCollection)
        {
            ...
            foreach (ITimeLineDataItem data in observableCollection)
            {
				...
				// Иванов - 12.02.2016 - добавлено
				if (_PeriodClick != null)
					adder.Click += _PeriodClick;
				// Иванов - 12.02.2016 - конец добавлено
			}
		...
		// Иванов - 12.02.2016 - добавлено
		public event RoutedEventHandler PeriodClick
		{
			add 
			{
				lock (this)
				{
					...
					{
						if (child is TimeLineItemControl)
							(child as TimeLineItemControl).Click += value;
					}
				}
			}
			remove
		...
		event RoutedEventHandler _PeriodClick;
		// Иванов - 12.02.2016 - конец добавлено
        ...
        private TimeLineItemControl CreateTimeLineItemControl(ITimeLineDataItem data)
        {
			...
			adder.TimeLineEndTime = timelineEnd;
            adder.DataContext = data;
            adder.Content = data;
			// Иванов - 04.02.2016 - добавлено
			adder.ReadOnly = ReadOnly;
			adder.ClickMode = ClickMode.Press;
			// Иванов - 04.02.2016 - конец добавлено
		...
		// Иванов - 12.02.2016 - private изменено на public
		...
		public void ReDrawChildren()
        {
			...
			// Иванов - 05.02.2016 - удалено
			//DateTime start = (DateTime)GetValue(StartDateProperty);
			// Иванов - 05.02.2016 - конец удалено
			Double w = 0;
            Double s = 0;
            Double e = 0;
            for (int i = 0; i < Items.Count; i++)
            {
                ...
                if (mover != null)
                {
					...
					mover.TimeLineStartTime = StartDate;
					// Иванов - 05.02.2016 - конец изменено
					// Иванов - 05.02.2016 - добавлено
					mover.TimeLineEndTime = EndDate;
					// Иванов - 05.02.2016 - конец добавлено
        ...
        internal Double GetMyWidth()
        {
			...
			if (EndDate != DateTime.MaxValue)
				return (EndDate - StartDate).TotalHours * UnitSize;
			// Иванов - 05.02.2016 - конец добавлено
        ...
        private void DrawTimeGridExecute()
        {
			...
			//if (Items == null)
			//	return;
			// Иванов 04.02.2016 - конец закомментировано
			...
			// Иванов 04.02.2016 - рефакторинг Extract Method
			DrawLines(grid);
			// Иванов 04.02.2016 - конец рефакторинг Extract Method
		}

		protected abstract void DrawLines(Canvas grid);
	...
	public class TimeLineHeader : TimeLineControlBase
	{
		...
		protected override void DrawLines(Canvas grid)
		{
			...
			//Size textSize = MeasureText("...", grid.
		}
	...
	// Иванов - 04.02.2016 - добавлен базовый класс TimeLineControlBase
    public class TimeLineControl : TimeLineControlBase
	{
