...
namespace TimeLineTool
{
	...
	public class TimeLineItemControl : Button
	{
		...
		public static readonly DependencyProperty ReadOnlyProperty =
			DependencyProperty.Register("ReadOnly", typeof(Boolean), typeof(TimeLineItemControl), new UIPropertyMetadata(false));
		#endregion
		...
		#region timeline end time
		public DateTime TimeLineEndTime
		{
			get { return (DateTime)GetValue(TimeLineEndTimeProperty); }
			set { SetValue(TimeLineEndTimeProperty, value); }
		}

		public static readonly DependencyProperty TimeLineEndTimeProperty =
			DependencyProperty.Register("TimeLineEndTime", typeof(DateTime), typeof(TimeLineItemControl),
			new UIPropertyMetadata(DateTime.MaxValue, new PropertyChangedCallback(OnTimeValueChanged)));
		#endregion
		...
		// Иванов - 11.02.2016 - internal изменено на public
		//internal Double CalculateLeftPosition()
		public Double CalculateLeftPosition()
		{
			DateTime start = (DateTime)GetValue(StartTimeProperty);
